...
public class Game extends Canvas implements Runnable {
    ...
    public void init() {
        ...
        try {
            // image backgrounds
            background = load.getBufferedImage("/images/menu_background.jpg");
            levelOne = load.getBufferedImage("/images/level_1.png");
            levelTwo = load.getBufferedImage("/images/level_2.png");
            levelThree = load.getBufferedImage("/images/level_3.png");

            // moveable images
            subSprite = load.getBufferedImage("/images/submarine.png");
            missile = load.getBufferedImage("/images/bitBullet.png");
            squidEnemy = load.getBufferedImage("/images/octo.png");
            sharkEnemy = load.getBufferedImage("/images/sharkEnemy.png");
            ink = load.getBufferedImage("/images/splat.png");
            kraken = load.getBufferedImage("/images/kraken.png");
            // livesSprite = load.getBufferedImage("/images/life.png");
            // sharkSprite = load.getBufferedImage("/images/shark.png");
            // bombSprite = load.getBufferedImage("/images/bomb.png");
            // smallBombSprite = load.getBufferedImage("/images/small_bomb.png");
